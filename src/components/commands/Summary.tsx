  ...
  return (
    <div className="space-y-6 text-sm md:text-base">
      ...
      <div>
        ...
        <div>
            <div className="text-white font-bold">{resumeData.education.degree}</div>
            <div className="text-white/70">{resumeData.education.institution}</div>
            <div className="text-white/50 text-xs">Graduated: {resumeData.education.graduation_date} | CGPA: {resumeData.education.cgpa}</div>
        </div>
      </div>
